...
from app.routers import schools, students, payment_types, payments, invoices, grades, users
...
app = FastAPI(
    ...
    version="1.0.0",
    openapi_tags=[
        {"name": "schools", "description": "Operaciones relacionadas con la gestión de colegios"},
        {"name": "students", "description": "Operaciones relacionadas con la gestión de estudiantes"},
        {"name": "invoices", "description": "Operaciones relacionadas con la gestión de facturas"},
        {"name": "payments", "description": "Operaciones relacionadas con la gestión de pagos"},
        {"name": "payment_types", "description": "Operaciones relacionadas con la gestión de tipos de pago"},
